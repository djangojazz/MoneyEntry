...
namespace MoneyEntry
{
    ...
    public partial class ExpensesEntities : DbContext
    {
        ...
        public virtual int spTransactionSummationByDuration(string xml)
        {
            var xmlParameter = xml != null ?
                new ObjectParameter("Xml", xml) :
                new ObjectParameter("Xml", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spTransactionSummationByDuration", xmlParameter);
        }
    }
}
