...
namespace MoneyEntry.Model
{
  ...
  {
    internal static Dictionary<int, Brush> Color
    {
      get => new Dictionary<int, Brush>
      {
        { 1, Brushes.Blue },
        ...
        { 23, Brushes.Navy },
        { 24, Brushes.DarkCyan },
        { 25, Brushes.MediumBlue },
        { 26, Brushes.SandyBrown },
        { 27, Brushes.LawnGreen },
        { 28, Brushes.SeaShell },
        { 29, Brushes.BlanchedAlmond },
